...
error = partial(_status, string='An error has ocurred!', color_code='red',
                stat_msg='[ERROR]', prn_out=True, time=False, space=False)
warning = partial(_status, string='Something is not right', color_code='yellow',
                  stat_msg='[WARNING]', prn_out=True, time=False, space=False)
success = partial(_status, string='Great success!', color_code='green',
                  stat_msg='[SUCCESS]', prn_out=True, time=False, space=False)
info = partial(_status, string='Information:', color_code='cyan',
               stat_msg='[INFO]', prn_out=True, time=False, space=False)
custom = partial(_status, string='Custom text', color_code='magenta',
                 stat_msg='[CUSTOM]', prn_out=True, time=False, space=False)
